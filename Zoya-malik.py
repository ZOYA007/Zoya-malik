...
\033[1;94m ┈┈┈▕▕Zoya-malik ▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕Zoya-malik▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mZoya malik.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93mZoya-Malik\033[1;91m...............

\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : zoya-malik

\033[1;92m☞ WhatsApp   : mazaq thori hy

\033[1;95m☞ Facebook   : Zoya-malik https://www.facebook.com/profile.php?id=100066332515975
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('https://www.facebook.com/profile.php?id=100066332515975)
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Zoya-Malik Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' Mazak hy kia WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Zoya-malik')

	    os.system('cd $HOME && git clone https://github.com/zoya-malik/')
	    ...
	    psb('WhatsApp Num Mazak hy kia✓')

	    psb('WellCome To Zoya Malik')

	    psb('Congratulations Zoya-Malik Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ Zoya✓')

	    psb('🔓Password ☆ Malik✓')

	    psb('Follow My Facebook accounthttps://www.facebook.com/profile.php?id=100066332515975 ✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/zoya-malik && python2 zoya-malik.py')

	elif bm =='3':

	    os.system('xdg-open https://chat.whatsapp.com'Mazak thori hy)
...
def pb():
	...
	print(S+'Broken Queen')     

	print

	raw_input(R + 'Back')

	os.system('zoya-malik.py')
